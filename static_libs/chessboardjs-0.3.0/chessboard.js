...
;(function () {
  ...
  var INTERACTION_MODE_DRAG = 'drag';
  var INTERACTION_MODE_SELECT = 'select';
  ...
  function expandConfig (config) {
    ...
    // default interaction mode is drag
    if (config.interactionMode !== INTERACTION_MODE_SELECT) config.interactionMode = INTERACTION_MODE_DRAG;
  ...
  function constructor (containerElOrString, config) {
    ...
    function mousedownSquare (evt) {
      ...
      if (config.interactionMode === INTERACTION_MODE_DRAG) {
        if (!currentPosition.hasOwnProperty(square)) return
        beginDraggingPiece(square, currentPosition[square], evt.pageX, evt.pageY)
      }

      if (config.interactionMode === INTERACTION_MODE_SELECT && isFunction(config.onSelect)) {
